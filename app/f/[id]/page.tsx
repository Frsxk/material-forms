...
import { getFormById, MOCK_FORMS } from '@/lib/mock-data';
...
export default function PublicFormPage() {
  ...
  const form = getFormById(formId) ?? MOCK_FORMS[0];
    ...
    return (
      <div className="min-h-screen bg-surface flex items-center justify-center px-4 md:px-6">
        <div className="text-center max-w-md animate-scale-in">
          ...
          <button
            onClick={() => { setSubmitted(false); setAnswers({}); setCurrentStep(0); }}
      ...
      <div className="px-4 md:px-6 pb-16 max-w-2xl mx-auto space-y-5 md:space-y-6">
        ...
        <div className="flex items-center justify-between pt-4">
          <button
            ...
            className="inline-flex items-center gap-2 rounded-full bg-primary px-8 py-3 text-on-primary font-medium cursor-pointer hover:shadow-(--m3-shadow-2) transition-all"
          >
            Submit
          </button>
          <button
